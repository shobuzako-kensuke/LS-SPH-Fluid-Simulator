module input
    ...
    !  SPH settings           !
    !=========================!
    integer, parameter :: Nx = 50                ! number of particles along x axis
    real(8), parameter :: Nh = 1.2d0             ! h = Nh * Delta x
    !=========================!
    !  system parameters      !
    !=========================!
    real(8), parameter :: rho_ref   = 1.0d0      ! reference density [kg m-3]
    real(8), parameter :: x_rand    = 0.0d0      ! position perturbation
    real(8), parameter :: threshold = 1.0d-12    ! iteration threshold

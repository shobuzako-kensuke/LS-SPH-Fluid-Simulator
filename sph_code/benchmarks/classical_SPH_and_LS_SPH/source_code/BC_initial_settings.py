...
#  xyz_kind               # 
#=========================#
def xyz_kind(N_sys, N_inn, WL_thick, width, parent_path, save_path):
    #=========================#
    #  read                   # 
    #=========================#
...
#  cell number            # 
#=========================#
def cell(N_sys, N_inn, WL_thick, width, h_eff, parent_path, save_path):
    #=========================#
    #  read                   # 
    #=========================#
    file_name = parent_path + '/data/0/SP_xyz.dat'          # SP_xyz
    ...
    draw_circle(ax, h_eff/width, center=(SP_xyz[0,0], SP_xyz[0,1])) # first inner particles
    # color bar
...
#  VM_kind                # 
#=========================#
def xyz_kind_VM(N_VM, N_inn, WL_thick, width, parent_path, save_path):
    #=========================#
    #  read                   # 
    #=========================#
...
#  cell number for VM     # 
#=========================#
def cell_VM(N_VM, N_inn, WL_thick, width, h_eff, parent_path, save_path):
    #=========================#
    #  read                   # 
    #=========================#
    file_name = parent_path + '/data/0/VM_xyz.dat'          # VM_xyz

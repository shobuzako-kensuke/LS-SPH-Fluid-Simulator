subroutine cal_WL_1st(n, N_link, W_link, &
    ...
    integer :: you
    real(8) :: V_j, sum_W, ans(5) ! rho, pre, u, v, tem
    sum_W = 0.0d0                 ! zero clear
    ans = 0.0d0
    ...
    do you = 1, N_link
        ...
        sum_W  = sum_W  + V_j * W_link(you)                   ! re-normalized term 
    ...
    ans(:) = ans(:) / sum_W ! re-normalized by sum_W
